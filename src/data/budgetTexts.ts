export const budgetTexts = {
  English: {
    ...
    budgetDetailTitle: 'Budget detail',
    viewBudgetDetails: 'View budget details',
    budgetDetailCategory: 'Category',
    budgetDetailLimit: 'Limit',
    budgetDetailSpent: 'Spent',
    budgetDetailCurrency: 'Currency',
  ...
  Turkish: {
    ...
    budgetDetailTitle: 'Bütçe detayı',
    viewBudgetDetails: 'Bütçe detayını görüntüle',
    budgetDetailCategory: 'Kategori',
    budgetDetailLimit: 'Limit',
    budgetDetailSpent: 'Harcanan',
    budgetDetailCurrency: 'Para birimi',
