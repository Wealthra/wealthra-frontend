...
import UIGraph from '@/components/AnalyticsComponents/UIGraph.vue'
import UIExpenseDistribution from '@/components/AnalyticsComponents/UIExpenseDistribution.vue'
    ...
    async fetchAnalyticsDataFromServer() {
      if (this.selectedDateRange) {
        ...
        try {
          ...
          if (categorySpending) {
            this.financialData.expenseDistribution = Object.entries(categorySpending).map(([category, amount]) => ({
              category,
              amount,
            }))
          }
