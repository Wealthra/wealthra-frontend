<template>
  <div class="landing-view-c">
      ...
      <div class="options">
        ...
        <div class="navbar-links">
          <router-link to="/login" class="login">{{
            buttonTexts[selectedLanguage].loginButtonText
          }}</router-link>
          <router-link to="/signup" class="sign-up">{{
            buttonTexts[selectedLanguage].signUpButtonText
          }}</router-link>
        </div>
      </div>
    </div>
    ...
    <div class="ending-text-wrapper animate-reveal">
      ...
      <router-link to="/signup" class="end-chapter-sign-up">
...
.landing-view-c {
  ...
  .login {
    ...
    &:hover {
      ...
      border: 1px solid var(--reverse-header-text-color);
